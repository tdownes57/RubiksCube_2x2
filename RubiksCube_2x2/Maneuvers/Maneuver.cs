...
namespace RubiksCube_2x2.Maneuvers
{
    public class Maneuver
    {
        ...
        internal void Execute_OneSide(RubiksCubeOneSide par_oneSide)
        {
            ...
            // More checks. 
            //
            //    Boolean variable created 8/9/2023 td
            //
            bool boolNoChange = (FrontClockFace.ten_thirty ==
                                 piece_starting_at_1030.FrontClockFacePosition.EnumValue());

            if (boolNoChange) //Boolean variable created 8/9/2023 td
            {

...
namespace RubiksCube_2x2
{
    ...
    namespace Front
    {
        class BlueWhiteOrange : RubikPieceCorner
        {
            ...
            public BlueWhiteOrange(string par_strBriefDescription) //, ClassBackside par_parentSide)
            {
            ...
            public override string ToString()
            {
                ...
                // Example #1:
                //
                //     BWO/NE==F1:N_F2:E_F3:F 
                //
                // Example #1:
                //
                //     BWO/SW==F1:S_F2:W_F3:F
                //
                //     (F = Front Face) 
                //
                return ("BWO/" + base.ToString());

...
namespace RubiksCube_2x2
{
    ...
    namespace Front
    {
        class GreenWhiteRed : RubiksPieceCorner
        {
            //
            ...
            public GreenWhiteRed(RubiksCubeOneSide par_sideParent = null) : base(par_sideParent)
            {
            ...
            public GreenWhiteRed(FrontClockFace_Enum par_enum) //Added 8/20/2023
            {
                //Added 8/21/2023 td
            ...
            public GreenWhiteRed(string par_strBriefDescription) //, ClassBackside par_parentSide)
            {
                ...
                //     (F = Front Face) 
                //
                if (par_strBriefDescription.StartsWith("GWR") == false) 
                    throw new ArgumentOutOfRangeException("Brief string must begin with GWR.");
